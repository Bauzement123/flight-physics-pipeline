...
| `--test-mode` | `flag` | *False* | Enables test mode: slices the cohort to 1 flight total, sets the start/end date to `2025-12-03` / `2025-12-04`, and disables day-by-day temporal windowing. |
